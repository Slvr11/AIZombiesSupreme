...
namespace AIZombiesSupreme
{
    public class mapEdit : BaseScript
    {
        ...
        public static void randomWeaponCrate(Vector3 origin, Vector3 angles, int? objID = null)
        {
        ...
        private static IEnumerator moveWeaponBox(Entity box, Entity bear)
        {
            ...
            yield return Wait(1.5f);
            randomWeaponCrate(boxLocations[newLoc][0], boxLocations[newLoc][1], objID);
        }
        ...
        private static void useGambler(Entity box, Entity player)
        {
            ...
            if (player.GetField<int>("cash") >= 1000)
            {
                ...
                AfterDelay(12500, () => gamblerRoll(player));
            }
        }

        private static void gamblerRoll(Entity player)
        {
        ...
        */
        ...
        private static string[] weaponNames = { "iw5_m60jugg_mp_eotechlmg_camo07", "iw5_mp412_mp", "iw5_deserteagle_mp",
            ...
            "iw5_msr_mp_msrscope", "iw5_aa12_mp", "iw5_1887_mp", "iw5_skorpion_mp", "iw5_mp9_mp", "iw5_p99_mp", "iw5_fnfiveseven_mp", "iw5_44magnum_mp", "iw5_fmg9_mp", "iw5_g18_mp", "iw5_smaw_mp",
