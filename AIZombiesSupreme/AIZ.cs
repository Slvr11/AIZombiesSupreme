...
//TODO: fix clearAllStrings reliableCmd client crash, fix crashes and closes involving memory scanning/setting, change the missing bear model?, fix raygun fire rate, fix waypoint baking(some waypoints seem to bake through walls/to 0)
//Map fixes: Liberation/Library humvee breach, Liberation/Bunker breach at large wall
...
namespace AIZombiesSupreme
{
    public class AIZ : BaseScript
    {
        ...
        public static readonly string version = "1.31 'Farewell Release'";
        ...
        public void onPlayerConnect(Entity player)
        {
            ...
            player.SetClientDvars("g_teamname_allies", gameStrings[17], "g_teamname_axis", "".PadRight(350));
        ...
        */
        ...
        private static void onGlobalNotify(int entRef, string message, params Parameter[] parameters)
        {
            ...
            if (!gameStarted)
            {
                ...
                else if (message == "fontPulse")
                {
                    ...
                    countdownText.SetText(gameStrings[20]);
        ...
        private static bool runIntermissionTimer(HudElem intermission)
        {
            ...
            intermission.SetText(gameStrings[21] + intermissionTimerNum);
        ...
        private static IEnumerator doIntro(Entity player)
        {
            ...
            intro.GlowAlpha = .7f;
            intro.SetText(string.Format(gameStrings[22],
        ...
        {
            if (player.HasField("bot") && player.GetField<Entity>("bot").GetField<string>("state") != "dead") StartAsync(killstreaks.killPlayerBotOnDeath(player));
        ...
        private static string[] initGameStrings()
        {
            ...
            switch (gameLanguage)
            {
                ...
                case "croation":
                    ...
                    strings[226] = "mp_killstreak_nuclearstrike";
                    strings[227] = "Nuklearka stiže za: ";
