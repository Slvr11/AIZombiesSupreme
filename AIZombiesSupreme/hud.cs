...
namespace AIZombiesSupreme
{
    public class hud : BaseScript
    {
        ...
        public static void createPlayerHud(Entity player)
        {
            ...
            weaponName.Alpha = 1;
            _setText(weaponName, string.Empty);
            weaponName.Sort = 0;
            ...
            _setText(scoreHud, AIZ.gameStrings[180]);
            scoreHud.Sort = 10;
            ...
            _setText(pointHud, AIZ.gameStrings[181]);
            pointHud.Sort = 11;
        ...
        public static IEnumerator createServerHud()
        {
            ...
            _setText(zombieCounter, AIZ.gameStrings[182] + "0");
            ...
            if (!AIZ.isHellMap)
            {
                ...
                _setText(powerHud, AIZ.gameStrings[183]);
                powerHud.Sort = 12;
            }
        }
        ...
        */
        public static void destroyGameHud()
        {
            for (int i = 65536; i < 66559; i++)
            {
                HudElem h = HudElem.GetHudElem(i);
        ...
        public static void _setText(HudElem hud, string text)
        {
            hud.SetText(text);

            if (AIZ.gameEnded) return;//Do not log config strings if the game ended already

            if (!unlocalizedConfigStrings.Contains(text))
            {
                unlocalizedConfigStrings[currentUnlocalizedConfigStrings++] = text;
            }

            //Check every time in case we're in danger zone
            if (currentUnlocalizedConfigStrings >= maxUnlocalizedConfigStrings_danger)
            {
        ...
        public static void clearAllGameStrings()
        {
            ...
            List<Entity> currentBotPool = botUtil.botPool;
            if (roundSystem.isBossWave) currentBotPool = botUtil.bossPool;
            else if (roundSystem.isCrawlerWave) currentBotPool = botUtil.crawlerPool;

            foreach (Entity bot in currentBotPool)
            {
                Entity botHitbox = bot.GetField<Entity>("hitbox");
                botHitbox.SetField("canBeDamaged", false);
            }
            ...
            currentUnlocalizedConfigStrings = 0;//Clear the count
        ...
        public static void scorePopup(Entity player, int amount)
        {
            ...
            AfterDelay(2000, () => checkForScoreChainEnd(score, scoreLine, oldScore, amount));
        }
        ...
        public static IEnumerator roundEndHud()
        {
            ...
            {
                _setText(roundEnd, AIZ.gameStrings[184]);
            ...
            {
                _setText(roundEnd, AIZ.gameStrings[186]);
                foreach (Entity players in Players)
                {
                    if (!players.IsAlive) continue;
                    AIZ.giveMaxAmmo(players);
            ...
            else _setText(roundEnd, AIZ.gameStrings[188] + roundSystem.Wave + AIZ.gameStrings[189]);
        ...
        public static IEnumerator powerBoughtHud(Entity buyer)
        {
            ...
            _setText(powerMessage, AIZ.gameStrings[190]);
        ...
        public static void tempPowerHud()
        {
            ...
            _setText(powerHud, string.Format(AIZ.gameStrings[191], EMPTime));
        ...
        public static IEnumerator endGame(bool win)
        {
            ...
            if (win)
            {
                ...
                PlaySoundAtPos(Vector3.Zero, "us_victory_music");
            }
            else
            {
                SetWinningTeam("axis");
                ...
                PlaySoundAtPos(Vector3.Zero, "us_defeat_music");
            }
        ...
        private static HudElem[] createEndGameScreen(bool win, string endText)
        {
            ...
            if (win)
            {
                ...
                _setText(leftScore, AIZ.gameStrings[196]);
            }
            else
            {
                leftScore.GlowColor = new Vector3(.8f, .2f, .2f);
                _setText(leftScore, AIZ.gameStrings[197]);
            }
            ...
            if (!win)
            {
                ...
                _setText(rightScore, AIZ.gameStrings[196]);
            }
            else
            {
                rightScore.GlowColor = new Vector3(.8f, .2f, .2f);
                _setText(rightScore, AIZ.gameStrings[197]);
            }
        ...
        private static HudElem[] createEndGameSequenceForPlayer(Entity player, bool win)
        {
            ...
            _setText(endGameText[0], AIZ.gameStrings[198]);
            ...
            _setText(endGameText[1], AIZ.timePlayedMinutes.ToString() + AIZ.gameStrings[199]);
            ...
            _setText(endGameText[2], AIZ.timePlayed.ToString() + AIZ.gameStrings[200]);
            ...
            if (win) _setText(endGameText[3], AIZ.gameStrings[201] + roundSystem.totalWaves.ToString());
            else _setText(endGameText[3], AIZ.gameStrings[201] + roundSystem.Wave.ToString());
            ...
            if (win) _setText(endGameText[4], AIZ.gameStrings[202]);
            else _setText(endGameText[4], AIZ.gameStrings[203]);
        ...
        public static void showPowerUpHud(string type, Entity player)
        {
            if (type == "gun")
            {
                ...
                _setText(personalInfo, AIZ.gameStrings[204]);
            ...
            if (type == "instakill")
            {
                _setText(info, AIZ.gameStrings[205]);
                if (killHud) return;
            ...
            {
                _setText(info, AIZ.gameStrings[206]);
                if (doubleHud) return;
                ...
                _setText(info, AIZ.gameStrings[207]);
            else if (type == "nuke")
                _setText(info, AIZ.gameStrings[208]);
            else if (type == "sale")
                _setText(info, AIZ.gameStrings[209]);
            else if (type == "freeze")
                _setText(info, AIZ.gameStrings[210]);
        }
        ...
        private static void initVoting()
        {
            ...
            _setText(currentMapDescs[2], AIZ.gameStrings[211]);
            ...
            _setText(controls, AIZ.gameStrings[212]);
            ...
            for (int i = 0; i < 2; i++)
            {
                _setText(currentMapDescs[i], "^5" + mapNames[mapLists[i]] + "\n^7" + mapDesc[mapLists[i]]);
            }
        ...
        */
        ...
        public static string createHudShaderString(string shader, bool flipped = false, int width = 64, int height = 64)
        {
            ...
            {
                color = shader.Substring(0, 2);
                shader = shader.Substring(2);
            }
            ...
            if (color != "")
                return color + ret + shader + "^7";
            else return ret + shader;
        }
        ...
        public static HudElem createIntermissionTimer()
        {
            ...
            _setText(intermission, AIZ.gameStrings[21] + AIZ.intermissionTimerNum);
            return intermission;
        }
